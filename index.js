...
// do we need to add the new categories
// will need to add user info

// there seems to be too much fields for
...
app.get("/", (request, response) => {
  response.send("Hello This is a server for the car show data");
});
